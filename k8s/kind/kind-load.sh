...
docker pull venkat34/new-api-gateway:latest
docker pull venkat34/new-product-service:latest
docker pull venkat34/new-order-service:latest
docker pull venkat34/new-inventory-service:latest
docker pull venkat34/new-notification-service:latest
...
kind load docker-image -n microservices venkat34/new-api-gateway:latest
kind load docker-image -n microservices venkat34/new-product-service:latest
kind load docker-image -n microservices venkat34/new-order-service:latest
kind load docker-image -n microservices venkat34/new-inventory-service:latest
kind load docker-image -n microservices venkat34/new-notification-service:latest
